<template>
  <Teleport to="body">
    ...
    >
      <div
        class="bottom-sheet fixed bottom-0 left-0 right-0 bg-[#161b22] border-t border-[#30363d] rounded-t-2xl px-4 pb-[max(env(safe-area-inset-bottom,0px),24px)] pt-0 max-h-[70vh] overflow-y-auto z-[1001]"
        :class="{ visible: sheetVisible }"
      >
