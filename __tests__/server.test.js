...
describe('Server API Endpoints', () => {
  ...
  describe('GET /', () => {
    it('should serve SPA index.html', async () => {
  ...
  describe('GET /session/:id', () => {
    it('should serve SPA for valid session routes', async () => {
      const response = await request(app)
    ...
    it('should not serve SPA for invalid session ID patterns', async () => {
      // IDs with special chars don't match SPA route regex
      await request(app)
